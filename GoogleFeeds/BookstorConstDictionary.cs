...
namespace GoogleFeeds
{
    ...
    public class BookstorConstDictionary
    {
        ...
        /// <summary>
        /// Dekoduje dział do kategori typu produktów (podobna jak w Google)
        /// 
        /// </summary>
        /// <param name="dzial"></param>
        /// <returns></returns>
        public static string dzial2ItemCategory (string dzial) {
                      switch (dzial)
                        {
                            case "KC":
                                return "Media > Books > Polskie Książki";
                                break;
                            case "AU":
                                return "Media > AudioBooks > Polish AudioBooks";
                                break;
                            case "GPL":
                                return "Toys & Games > Games > Polskie gry planszowe";
                                break;
                            case "PU":
                                 return "Toys & Games > Puzzles ";
                                break;
                            case "FL":
                                 return "Media > DVDs & Videos (Movies)";
                                break;
                            case "KL":
                                 return "Office Supplies > Filing & Organization > Calendars, Organizers & Planners";
                                break;
                            case "MZ":
                                return "Media > Music > Polish Music";
                                break;
                            case "MM":
                                return "Software > Computer Software> Multimedia & Design Software";
                                break;
                            case "ZBW":
                                return  "Toys & Games > Toys";
                                break;
                            default:
                                return "Media > Books > Produkts from Poland";
                                break;
                        }
        }

        /// <summary>
        /// Dekoduje dział do kategori google
        /// 
        /// </summary>
        /// <param name="dzial"></param>
        /// <returns></returns>
        public static string dzial2GoogleCategory(string dzial) {
                      switch (dzial)
                        {
                            case "KC":
                                return "Media > Books";
        ...
        #region Funkcje i metody przekopiowane z NOP.commeroce - nie edytować
        ...
        /// Get SE name.
        /// 
        /// Example: BookstorConstDictionary.GetSeName(item.title, true, false)
        /// </summary>
